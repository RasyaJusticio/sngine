        ...
        <div class="plr20">
          <div class="mb5">
            ...
            <span class="float-end">
              <span class="text-lg">
                {print_money($order['sub_total']|convert_money|format_money)}
              </span>
            </span>
          </div>
          {if $sales}
            <div class="mb5">
              ...
              <span class="float-end">
                <span class="text-lg">
                  - {print_money($order['total_commission']|convert_money|format_money)}
                </span>
              </span>
            </div>
            ...
            <div class="mb5">
              ...
              <span class="float-end">
                <span class="text-lg">
                  <strong>
                    {print_money($order['final_price']|convert_money|format_money)}
                  </strong>
                </span>
              </span>
            </div>
