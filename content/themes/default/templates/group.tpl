    ...
    <div class="col-12 sg-offcanvas-mainbar">
      ...
      <div class="row">
        ...
        {if $view == ""}
          ...
          <!-- left panel -->
          <div class="{if $system['chat_enabled'] && $group['chatbox_enabled']}col-lg-3 order-3 order-lg-1{else}col-lg-4 order-2 order-lg-1{/if}">
            <!-- ads -->
            ...
            {if $user->_logged_in && !$group['i_admin'] && $group['has_subscriptions_plans']}
              <div class="d-grid">
                <button class="btn btn-primary rounded rounded-pill mb20" data-toggle="modal" data-url="monetization/controller.php?do=get_plans&node_id={$group['group_id']}&node_type=group" data-size="large">
                  <i class="fa fa-money-check-alt mr5"></i>{__("SUBSCRIBE")} {__("STARTING FROM")} ({print_money($group['group_monetization_min_price']|convert_money|format_money)})
                </button>
              </div>
            {/if}
            <!-- subscribe -->
                ...
                <ul class="about-list">
                  ...
                  <li>
                    <div class="about-list-item">
                      ...
                      {__($group['photos_count'])} {__("Photos")}
                    </div>
                  </li>
                  <!-- photos -->
                  {if $system['videos_enabled']}
                    ...
                    <li>
                      <div class="about-list-item">
                        ...
                        {__($group['videos_count'])} {__("Videos")}
                      </div>
                    </li>
                    <!-- videos -->
                  {/if}
          ...
          <!-- right panel -->
          <div class="{if $system['chat_enabled'] && $group['chatbox_enabled']}col-lg-6 order-1 order-lg-2{else}col-lg-8 order-1 order-lg-2{/if}">
