    ...
    <div class="col-md-4 col-lg-3 sg-offcanvas-sidebar admin-sidebar">
      ...
      {if $user->_is_admin}
        <div class="card mb15 x-hidden">
          ...
          <div class="card-body with-nav">
            <ul class="side-nav">
              <li {if $view == "activities"}class="active" {/if}>
                <a href="#activities" data-bs-toggle="collapse" {if $view == "activities"}aria-expanded="true" {/if}>
                  <i class="fa fa-calendar-days fa-lg fa-fw mr10" style="color: #ffc107"></i>{__("Activities")}
                </a>
                <div class='collapse {if $view == "activities"}show{/if}' id="activities">
                  <ul>
                    <li {if $view == "activities" && $sub_view == ""}class="active" {/if}>
                      <a href="{$system['system_url']}/{$control_panel['url']}/activities">
                        {__("Activities Settings")}
                      </a>
                    </li>
                    <li {if $view == "activities" && $sub_view == "categories"}class="active" {/if}>
                      <a href="{$system['system_url']}/{$control_panel['url']}/activities/categories">
                        {__("List Categories")}
                      </a>
                    </li>
                  </ul>
