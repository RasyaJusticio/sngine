    ...
    <div class="col-12 sg-offcanvas-mainbar">
      ...
      <div class="profile-tabs-wrapper d-flex justify-content-evenly">
        ...
        {if $system['pages_activities_enabled'] && $spage['page_activities_enabled']}
          <a href="{$system['system_url']}/pages/{$spage['page_name']}/activities" {if $view == "activities"}class="active" {/if}>
            {include file='__svg_icons.tpl' icon="activities" class="main-icon mr5" width="24px" height="24px"}
            <span class="ml5 d-none d-xl-inline-block">{__("Activities")}</span>
          </a>
        {/if}
        {if $spage['i_like']}
          ...
          <div class="col-12">
            <div class="card">
              <div class="card-header with-icon">
                ...
                {if $spage['activities_permission'] == "editor"}
                  <div class="float-end">
                    <button class="btn btn-md btn-primary d-none d-lg-block" data-toggle="modal" data-url="modules/activities.php?do=add&id={$spage['page_id']}">
                      <i class="fa fa-plus-circle mr5"></i>{__("Create Activity")}
                    </button>
                    <button class="btn btn-sm btn-icon btn-success d-block d-lg-none" data-toggle="modal" data-url="modules/activities.php?do=add&id={$spage['page_id']}">
                      <i class="fa fa-plus-circle"></i>
                    </button>
                  </div>
                {/if}
              ...
              <div class="card-body">
                {if $spage['activities_permission']}
                  {if $spage['activities']}
                    <ul class="row">
                      {foreach $spage['activities'] as $activity}
                        {include file='__feeds_activity.tpl'}
                      {/foreach}
                    </ul>

                    {if count($spage['activities']) >= $system['max_results_even']}
                      <!-- see-more -->
                      <div class="alert alert-post see-more js_see-more" data-get="page_activities" data-id="{$spage['page_id']}">
                        <span>{__("See More")}</span>
                        <div class="loader loader_small x-hidden"></div>
                      </div>
                      <!-- see-more -->
                ...
                {else}
                  <div class="alert alert-warning">
                    {__("Sorry, You don't have permission to view this page's activities")}
                  </div>
                  ...
                  {if $case == "pending"}
                    <div class="text-center">
                      ...
                      <h4>{__("Pending")}</h4>
                      <p class="mt20">{__("Your request is still awaiting admin approval")}</p>
                    </div>
                  {elseif $case == "declined"}
                    <div class="text-center">
                      {include file='__svg_icons.tpl' icon="report" class="danger-icon mb10" width="60px" height="60px"}
                      <h4>{__("Declined")}</h4>
                      <p class="mt20">{__("Your request has been declined by the admin")}</p>
                    </div>
                  {else}
                    <!-- request permission -->
                    <div class="text-center text-muted mb20">
                      <button class="btn btn-lg btn-primary js_activities-permission-request" data-id="{$spage['page_id']}">
            ...
            <div class="card">
              <div class="card-body with-nav">
                <ul class="side-nav">
                  ...
                  {if $system['pages_activities_enabled'] && $spage['page_activities_enabled']}
                    <li {if $sub_view == "activities"}class="active" {/if}>
                      <a href="{$system['system_url']}/pages/{$spage['page_name']}/settings/activities">
                        {include file='__svg_icons.tpl' icon="activities" class="main-icon mr10" width="24px" height="24px"}
                        {__("Activities")}
                      </a>
                    </li>
            ...
            <div class="card">
                  ...
                  <div class="card-body">
                    ...
                    {if $system['pages_activities_enabled']}
                      ...
                      <div class="form-table-row">
                        ...
                        <div>
                          <div class="form-label h6">{__("Activities Enabled")}</div>
                          <div class="form-text d-none d-sm-block">{__("Allow the activities on your page")}</div>
                        </div>
                        <div class="text-end">
                          <label class="switch" for="page_activities_enabled">
                            <input type="checkbox" name="page_activities_enabled" id="page_activities_enabled" {if $spage['page_activities_enabled']}checked{/if}>
                            <span class="slider round"></span>
                          </label>
                        </div>
                      </div>
              ...
              {elseif $sub_view == "activities"}
                ...
                <div class="card-body">
                  ...
                  <div class="pl-md-4">
                    {if $spage['page_activities_users']}
                      <ul>
                        {foreach $spage['page_activities_users'] as $_user}
                          {include file='__feeds_user.tpl' _tpl="list" _connection=$_user["connection"]}
                        {/foreach}
                      </ul>

                      {if count($spage['page_activities_users']) >= $system['max_results_even']}
                        <!-- see-more -->
                        <div class="alert alert-post see-more js_see-more" data-get="page_activities_users" data-id="{$spage['page_id']}">
                          <span>{__("See More")}</span>
                          <div class="loader loader_small x-hidden"></div>
                        </div>
                        <!-- see-more -->
                    ...
                    {else}
                      <p class="text-center text-muted mt10">
                        {$spage['page_title']} {__("doesn't have activities viewers & editors")}
                      </p>
                    {/if}
                  </div>
                  <!-- admins -->
                  ...
                  <div class="pl-md-4">
                    {if $spage['page_activities_permission_requests']}
                      <ul>
                        {foreach $spage['page_activities_permission_requests'] as $_user}
                          {include file='__feeds_user.tpl' _tpl="list" _connection=$_user["connection"]}
                        {/foreach}
                      </ul>

                      {if count($spage['page_activities_permission_requests']) >= $system['max_results_even']}
                        <!-- see-more -->
                        <div class="alert alert-post see-more js_see-more" data-get="page_activities_permission_requests" data-id="{$spage['page_id']}">
                          <span>{__("See More")}</span>
                          <div class="loader loader_small x-hidden"></div>
                        </div>
                        <!-- see-more -->
                    ...
                    {else}
                      <p class="text-center text-muted mt10">
                        {$spage['page_title']} {__("doesn't have activities permission requests")}
                      </p>
                    {/if}
                  </div>
                  <!-- members -->
