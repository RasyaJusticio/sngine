{strip}
  ...
  <script>
    ...
    __['Mark as Unavailable'] = "{__('Mark as Unavailable')}";
  ...
  <script src="https://ajax.googleapis.com/ajax/libs/jquery/3.7.1/jquery.min.js" {if !$user->_logged_in}defer{/if}>
  ...
  {if $user->_logged_in}
    ...
    {if $system['audio_call_enabled'] || $system['video_call_enabled']}
      <script src="https://sdk.twilio.com/js/video/releases/2.28.1/twilio-video.min.js" defer></script>
    {/if}
    <!-- Twilio -->
    ...
    {if $page == "admin" || $page == "ads" || $page == "wallet" || $page == "developers" || $page == "settings"}
      <link rel="stylesheet" type="text/css" href="https://cdn.datatables.net/2.1.7/css/dataTables.bootstrap5.min.css" defer />
      <script src="https://cdn.datatables.net/2.1.7/js/dataTables.js" defer></script>
      <script src="https://cdn.datatables.net/2.1.7/js/dataTables.bootstrap5.min.js" defer></script>
    {/if}
    <!-- Datatables -->

    <!-- Tagify -->
    {if $page =="admin" || $page =="packages" || $page == "settings" || $page == "blogs"}
    ...
    <!-- XRegExp -->
    <script src="https://unpkg.com/xregexp/xregexp-all.js" defer></script>
    <!-- XRegExp -->
  {/if}
  <!-- Dependencies Plugins -->
  ...
  {if $user->_logged_in && $page != "reels" && $system['onesignal_notification_enabled']}
    ...
    <script>
      ...
      function saveAndroidOneSignalUserId(onesignal_user_id) {
        $.post(api['users/notifications'], { handle: 'update_android', id: onesignal_user_id });
      }

      function saveIOSOneSignalUserId(onesignal_user_id) {
        $.post(api['users/notifications'], { handle: 'update_ios', id: onesignal_user_id });
      }
