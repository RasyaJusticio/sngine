    ...
    <div class="col-12 sg-offcanvas-mainbar">
      ...
      <div class="row">
        ...
        {if $view == ""}
          ...
          <!-- left panel -->
          <div class="{if $system['chat_enabled'] && $event['chatbox_enabled']}col-lg-3 order-3 order-lg-1{else}col-lg-4 order-2 order-lg-1{/if}">
            <!-- ads -->
          ...
          <!-- right panel -->
          <div class="{if $system['chat_enabled'] && $event['chatbox_enabled']}col-lg-6 order-1 order-lg-2{else}col-lg-8 order-1 order-lg-2{/if}">
            <!-- super admin alert -->
