<?php
/* Smarty version 5.4.1, created on 2025-03-26 07:04:10
  from 'file:jobs.tpl' */

/* @var \Smarty\Template $_smarty_tpl */
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.4.1',
  'unifunc' => 'content_67e3a6eaa429a9_86511343',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    'e81747122f6ec8fe4a7c5a579fe285bff968cc3f' => 
    array (
      0 => 'jobs.tpl',
      1 => 1726841512,
      2 => 'file',
...
function content_67e3a6eaa429a9_86511343 (\Smarty\Template $_smarty_tpl) {
 ...
 "<strong class="text-primary"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('htmlentities')($_smarty_tpl->getValue('query'),ENT_QUOTES,'utf-8');?>
      ...
      <?php if ($_smarty_tpl->getValue('view') == '' && $_smarty_tpl->getValue('promoted_jobs')) {?>
        <div class="blogs-widget-header">
          <div class="blogs-widget-title"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Promoted Jobs");?>
</div>
        </div>
        <div class="row mb20">
          <?php
...
$_smarty_tpl->getSmarty()->getRuntime('Foreach')->restore($_smarty_tpl, 1);?>
      ...
      <div class="blogs-widget-header clearfix">
        <div class="blogs-widget-title"><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Jobs");?>
</div>
        <!-- sort -->
        <div class="float-end">
          <div class="dropdown">
