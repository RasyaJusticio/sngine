<?php
/* Smarty version 5.4.1, created on 2025-03-26 09:06:33
  from 'file:admin.stickers.tpl' */

/* @var \Smarty\Template $_smarty_tpl */
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.4.1',
  'unifunc' => 'content_67e3c399511322_95633580',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '775d5a7fee68a7fe4173aca3e6da3840cd2ee237' => 
    array (
      0 => 'admin.stickers.tpl',
      1 => 1714805472,
      2 => 'file',
    ),
  ),
...
function content_67e3c399511322_95633580 (\Smarty\Template $_smarty_tpl) {
...
/stickers/add" class="btn btn-md btn-primary">
          <i class="fa fa-plus mr5"></i><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Add New Sticker");?>
...
/stickers" class="btn btn-md btn-light">
    ...
    <?php }?>
    <i class="fa fa-hand-peace mr10"></i><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Stickers");?>

    <?php if ($_smarty_tpl->getValue('sub_view') == "add") {?> &rsaquo; <?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Add New Sticker");
}?>
    <?php if ($_smarty_tpl->getValue('sub_view') == "edit") {?> &rsaquo; <?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Edit Sticker");
}?>
  </div>
...
?>
              <tr>
                <td><?php echo $_smarty_tpl->getValue('row')['sticker_id'];?>
</td>
...
/<?php echo $_smarty_tpl->getValue('control_panel')['url'];?>
/stickers/edit/<?php echo $_smarty_tpl->getValue('row')['sticker_id'];?>
" class="btn btn-sm btn-icon btn-rounded btn-primary">
                    <i class="fa fa-pencil-alt"></i>
                  </a>
                  <button data-bs-toggle="tooltip" title='<?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Delete");?>
' class="btn btn-sm btn-icon btn-rounded btn-danger js_admin-deleter" data-handle="sticker" data-id="<?php echo $_smarty_tpl->getValue('row')['sticker_id'];?>
">
...
'></button>
  ...
  <?php } elseif ($_smarty_tpl->getValue('sub_view') == "edit") {?>
    ...
    <form class="js_ajax-forms" data-url="admin/stickers.php?do=edit&id=<?php echo $_smarty_tpl->getValue('data')['sticker_id'];?>
">
      <div class="card-body">
        <div class="row form-group">
          <label class="col-md-3 form-label">
