<?php
/* Smarty version 5.4.1, created on 2025-03-26 09:55:22
  from 'file:admin.offers.tpl' */

/* @var \Smarty\Template $_smarty_tpl */
if ($_smarty_tpl->getCompiled()->isFresh($_smarty_tpl, array (
  'version' => '5.4.1',
  'unifunc' => 'content_67e3cf0af3a4c4_04792594',
  'has_nocache_code' => false,
  'file_dependency' => 
  array (
    '0a6f40ae230b800bfe1b6ba98db9b9dae437e82d' => 
    array (
      0 => 'admin.offers.tpl',
      1 => 1715066916,
      2 => 'file',
...
function content_67e3cf0af3a4c4_04792594 (\Smarty\Template $_smarty_tpl) {
...
/offers/categories" class="btn btn-md btn-light">
    ...
    <?php }?>
    <i class="fa fa-tag mr10"></i><?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Offers");?>
...
/offers/find" method="get">
        ...
        <div class="form-text small">
          <?php echo $_smarty_tpl->getSmarty()->getModifierCallback('__')("Search by Offer Title or Description");?>
...
?>
                <tr>
                  ...
                  <td>
                    <a target="_blank" href="<?php echo $_smarty_tpl->getValue('row')['offer_author_url'];?>
">
                      <img class="tbl-image" src="<?php echo $_smarty_tpl->getValue('row')['offer_author_picture'];?>
">
                      <?php echo $_smarty_tpl->getValue('row')['offer_author_name'];?>
...
?>
                <?php $_smarty_tpl->renderSubTemplate('file:__categories.recursive_rows.tpl', $_smarty_tpl->cache_id, $_smarty_tpl->compile_id, 0, $_smarty_tpl->cache_lifetime, array('_url'=>"offers",'_handle'=>"offers_category"), (int) 0, $_smarty_current_dir);
?>
              <?php
}
$_smarty_tpl->getSmarty()->getRuntime('Foreach')->restore($_smarty_tpl, 1);?>
...
$_smarty_tpl->getSmarty()->getRuntime('Foreach')->restore($_smarty_tpl, 1);?>
  ...
  <?php } elseif ($_smarty_tpl->getValue('sub_view') == "edit_category") {?>
    ...
    <form class="js_ajax-forms" data-url="admin/offers.php?do=edit_category&id=<?php echo $_smarty_tpl->getValue('data')['category_id'];?>
">
      <div class="card-body">
        <div class="row form-group">
          <label class="col-md-3 form-label">
